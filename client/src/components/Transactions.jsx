...
const Transactions = () => {
  const { transactionsRef, currentAccount, transactions } = useContext(TransactionContext);
  return (
    <div ref={transactionsRef} className='flex flex-col w-full justify-center items-center 2xl:p-20 bg-transparent'>
